...
export default function homeView() {
  ...
  setTimeout(() => {
    ...
    // Cargar lógica principal
    homeController();

    // Botón Nueva Reserva (usuario)
    document
    ...
    // Botón Gestionar Reservas (admin)
    document
      .getElementById("manageReservations")
      ?.addEventListener("click", () => {

        alert("Gestionar Reservas");
      ...
      <main class="flex-1 p bg-slate-100 min-h-screen">
        ...
        >
          ...
          >
            ...
            <div
              class="w-full text-center py-8 col-span-2"
            >
